...
{
    internal class FdcFormatConverter : JsonConverter<FdcFormat>
    {
        FdcFormatTranslator _translator = new();

        public override FdcFormat Read(ref Utf8JsonReader reader,
        ...
        public override void Write(Utf8JsonWriter writer,
            FdcFormat value, JsonSerializerOptions options)
        {
